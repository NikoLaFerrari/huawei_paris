...
trace_path = [
        ...
        "./traces/trace1.json",
        #"./traces/trace2.json",
        #"./f50467f1de88/f50467f1de88.json",
        #"./353a284af50d/353a284af50d.json",
        ]
...
config_path = [
         ...
         "./configs/config.yaml",
         #"./configs/config.yaml",
         #"./f50467f1de88/f50467f1de88.yaml",
         #"./353a284af50d/353a284af50d.yaml"
         ]
...
graphs = [
         ...
         "./graphs",
         #"./graphs/graphs",
         #"/mnt/disk0/j50056410/toolkits/regression/f50467f1de88/graphs",
         #"./353a284af50d/graphs"
        ]
